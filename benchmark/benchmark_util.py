...
content_list = [
    ...
    ('Kaeya flirting\nsadly I couldn t take the ss of the best scene☹️😔', 'EN', 'IT'), 
    ...
    ('I’m Excited!\nI’m really excited to earn more primos. I don’t have a specific character I want this update so I’m hyped to work for characters I want!', 'EN', 'TR'), 
    ('Amplifying Test.\nIs it possible to win a beta ticket lmao.', 'EN', 'ID'), 
    ('Dan & Jing Yuan Team\nThis was before Aventurine came out. Now Gepard can go into retirement The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'EN', 'PT'), 
    ...
    ('Eula enjoying a peaceful day in Mondstadt\nI drew Eula in Procreate app but the background is AI generated. This is the first image I made like this. I lost motivation to drawing when I started to do a similar background from scratch. It would take too long at my level of skill. Maybe one day its possible.', 'EN', 'ES'), 
    ...
    ("My mom likes huohuo sticker\nIn whatsapp I have huohuos stickers from in game and don't judge but I send them to my mom and now she uses them sometimes when talking to me...", 'EN', 'TR'), 
    ('I FINALLY FOUND THE ORIGINAL ARTIST FOR THESE ARTS YESSS\nthey also did the xiao and venti s birthday art, lyney and xiao s valentines/white day art too (and i forgot the rest)', 'EN', 'IT'), 
    ('Oh\nI believe father will come home😤', 'EN', 'ES'), 
    ...
    ("Blade hypercarry & Daniel hypercarry\nDidn't think i'll make it in 10 turns but i managed first try! Nice to see i can still 3 star with older characters and without dot/acheron.The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~", 'EN', 'IT'), 
    ...
    ('LYNEY\nFOUR DAYS TIL LYNEY IS BACK😭😭', 'EN', 'TR'), 
    ...
    ('Ladies and gentlemen we have found klees sibling\nMay I present to you sparkle in a canon universe', 'EN', 'IT'), 
    ...
    ('Totally not obsessed\nI absolutely love his character and boss fight (even tho he killed my dps and had to restart). Cant wait for his nova desktop animated wallpaper.', 'EN', 'ES'), 
    ...
    ('Whyyy😭😭\nI tried pulling for neuvillettes signature but got kazuhas sword😭😭. I lost every 50/50 on my account since playing bra😭', 'EN', 'IT'), 
    ...
    ('🐈\u200d⬛ Pardo time! Some pics.\nI took videos but i hate that I can t post them there. It was so hot outside i was dying but i loved the pics. My official photos will be at Otakufest on Saturday. One of my friends are bringing Elysia so it will be so pretty to take pics with. I tried buying the Can plushie but no one is selling it. :( I hope you guys enjoy this cute pics. And thanks again for the support. I rlly want to cosplay Mobius tho. But she s so expensive.', 'EN', 'ES'), 
    ('Acheron/Jingliu hypercarry\nBoosted Nihility and overkilling Jingliu!The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'EN', 'TR'), 
    ('Cant fast travel, else im stuck in the loading screen. Anyone have a solution for this? Using a pc btw\nThis issue just came up today, and to this day it was all fine then idk what happened. You can log in just fine, get into the game just fine, but then if you try to fast travel anywhere the loading screen will be just like that theres no progress increasing at all, and when you are finished doing a battle it will be the same except its a black screen, its been so long waiting and nothing happens. I already tried reinstalling the app, check all of my drivers and its all up to date, i tried changing my provider data, clear the cache, and its still the same. Do you guys have any solution please fix and give the solution fast. thank you!', 'EN', 'TR'), 
    ('neuvillette photos!\ni finally got neuvi after losing my 50/50', 'EN', 'PT'), 
    ...
    ('What s up with this?\nA friend of mine pointed this out and I thought it was post worthy. They look so similar so whats the deal with it? Same eyes, headband, and eyes that I can see. I guess we have to wait till 4.6 and see if this is talked about!', 'EN', 'TR'), 
    ...
    ('Did it with sampo cleared with 3 stars on exactly 20\nSampo: What are you waiting forAbuse the trottersThe content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'EN', 'IT'), 
    ...
    ('My drawing\nNot Hoyoverse related but please support my art on Instagram, Youtube and Tiktok! <3 \n@yuanting_insta\n@yuanting_yt\n@yuanting_tiktok', 'EN', 'IT'), 
    ('Sethos Art\nSethos art I finally finished 😆', 'EN', 'TR'), 
    ("Favorite places to meet Kaeya in game\nWhen you do his quest at the beginning of the game, he's just chilling in the headquarters and when the Sumeru quest was going on (him talking to the bird was hilarious like what are you doing good sir?) ", 'EN', 'PT'), 
    ...
    ('everyone know 🤭\ninspire by arlecchino animation', 'EN', 'IT'), 
    ...
    ('this animation was actually so cool omg\narlechinnos backstory is so sad', 'EN', 'PT'), 
    ('Day 3\nDay 3 of posting for jingliu frame~', 'EN', 'PT'), 
    ...
    ("Wanna give a shoutout to my HSR friend\nThank you for your e6 Acheron, without using her as a support, I don't think I'd be able to get Aventurine's trace materials so fast.", 'EN', 'TR'), 
    ("My luck is shining a bit too much this patch... 😃\nI didn't had any hopes of getting any 5* weapon early... Well at least something is better than nothingI was trying to get neuvi's weapon but ended with kazuha's XD", 'EN', 'PT'), 
    ...
    ('Mageblade corrouge\nJust spent 30 minutes of my time swimming and dodging the bubble, than attacking mageblade with XENOCHROMATIC JELLYFISH and defeated it\U0001f979😨Then googled it just to know you need to use the XENOCHROMATIC BALL OCTOPUS to defeated it faster 🥲🥲🥲', 'EN', 'IT'), 
    ...
    ("Day 6 - Cool Pose\nY'all should try to take ei's photo using 2nd acc to explore more pose. A lot of nice shots with new angle we can get. This is one of the example ", 'EN', 'TR'), 
    ...
    ('Silver wolf day 14\nWhat rank would silverwolf be in valorant?', 'EN', 'TR'), 
    ('130 pulls just for him\nI started saving after I got Argenti', 'EN', 'FR'), 
    ('Team Comp for new f2p\nHello!!! I was wondering if some more knowledgeable HSR players could recommend a team comp with the characters I own.', 'EN', 'IT'), 
    ...
    ('How my 2.1 Pulls went!\nI’m actually so happy I got Aventurine, I fell in love him with the MOMENT I heard his voice from that one call with topaz. While I am kinda pisse* that I STILL don’t have Lighting dps but Oh well ig. But still I’m happy that Aventurine is home so I can give him the love he deserves.', 'EN', 'TR'), 
    ...
    ('Best reporter and photographer ever\nCharlotte has to be the best reporter and photographer of the steambird so far cuz no one can get a scoop like Charlotte', 'EN', 'PT'), 
    ...
    ('do you ever love one man so much\nMostly free to play but I had to go all out for aven... here s to hoping Robin comes home early because he did not make it easy 🤣', 'EN', 'PT'), 
    ...
    ("Daily Clara post\nLike if you like Clara, comment why if you don't ", 'EN', 'IT'), 
    ('Happy Birthday Yelan!💦🛐\nOne Of The Best Hydro Characters💫\U0001f979\n\nShe s so good that I wish I had her, but I m saving for someone else(right now)😭', 'EN', 'TR'), 
    ...
    ('Favourite dps?\nComment your favourite dps and the reason why', 'EN', 'IT'), 
    ...
    ('Deja Vu!\nXaoi , Zhongli , traveler , Paimon', 'EN', 'PT'), 
    ...
    ('look at this stupid ass- 😭😭\nmanga : To Make A Delicious Omega Squeak', 'EN', 'PT'), 
    ...
    ('First Time 3 star MoC 12 Auto Battle\nThank you my Blind Queen and Direction Challenged QueenThe content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'EN', 'TR'), 
    ...
    ('FURINAA\nDon’t worry guys! She’s just overflowing with Hydro…\n\nInspired by silent film makeup and that Focalors design by phosfulate on insta', 'EN', 'TR'), 
    ...
    ('Arrlecchino will come soon! Arlecchino will come soon!!\nI listened this short event woth headphones. I could hear those stairs cracking into my brain after they went throw my ears No one:Arlecchino: X_XThis mini-movie got me, not gonna lie! It hit me with the chills and tons of questions!', 'EN', 'TR'), 
    ...
    ("Rip and tear\nI should really build more characters so I don't use the same ones over and over...The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~", 'EN', 'TR'), 
    ...
    ('this event is about turning honkai beasts into food !!\nyeah, the honkai beasts, consecrated honkai lifeforms that turns people into zombies just by standing next to them, in oxia they get turned into food for its people to eat.oxia people are built differently. ', 'EN', 'PT'), 
    ...
    ('Is he good with aventurine?\nI lost Jingliu 50/50 and now im stuck with choosing either Him or Dr Ratio. Im trying to make a 2nd team for MoC and PF', 'EN', 'TR'), 
    ...
    ("Yanqing slayed / welt with stolen artifacts ...\nDon't know what to say just that yanqing carried the team ! The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~", 'EN', 'ES'), 
    ...
    ('Spending 1100 days in Genshin Imapct ✨\nIt is a honor to play Hoyoverse game for this long and continue to play it till the end...We love you Hoyoverse, no matter what <3', 'EN', 'PT'), 
    ("Whyyyy does my genshin burnout have to overlap with the time I need to save for Arlecchino 😭\nI wish I could pause time because I haven't played genshin in months but I need Arlecchino soooo badddddddddd but not badly enough to load up the game and then I'll be so upset because the moment I get the energy to play genshin again it'll be right after her banner ends", 'EN', 'PT'), 
    ...
    ('Swan diving into achievement hunt\nFor this one I recommend using the current forgotten hall stages since so much dot in them that getting 20 stacks off of swan should be easy', 'EN', 'ES'), 
    ...
    ('my kazuha pull!\ni got xiao at pity 30 after i got Jean, which im happy bcs i got him at early pity but lost my 50/50 at kazuha banner hurt a bit, it s fine tho since it s qiqii (see ya at the next banner kazuha :D)', 'EN', 'PT'), 
    ...
    ('Arlecchino Please Come home 😭\nSaving for Arlecchino Day 20 after getting Kazuha on pity 76. TBH I m always at red pity. 😭 Just please for one just please Hoyo gime ‘Father’ Arlecchino at soft pity I BEG YOU', 'EN', 'IT'), 
    ...
    ('He s so goated in game guys pull for aventurine\ni use blade, ratio, aven, loucha team, is it ok???', 'EN', 'PT'), 
    ...
    ('it s complete\nThe last imaginary member finally came home', 'EN', 'PT'), 
    ...
    ('itto s long last brother\nItto and Tengen would be besties tbh', 'EN', 'IT'), 
    ...
    ('Savings :3\nReady to b stepped on by cappuccino', 'EN', 'PT'), 
    ...
    ("In search of new friends\nlooking for some new friends that are as interested, for Genshin and Star Rail, as me. Doesn’t have to be serious just chill vibesI'm on EU serversdiscord: dennis2300", 'EN', 'ES'), 
    ...
    ('he looks so pretty in casual wear I cant-\nomagajd please your hand in marriage?!?!', 'EN', 'ES'), 
    ...
    ("When in doubt, rainbow\nRainbow-coloured first aniversary cake#anniversary cake#Honkai Star Rail: First Anniversary CelebrationI have no idea what I'm doing", 'EN', 'IT'), 
    ...
    ('Lucky E1 S1 in less than 200 pulls\nWon all the 50/50. Luck is on my side.', 'EN', 'PT'), 
    ...
    ('This dude just give me what??\nI ve been strengthening my straightness by \\ ignoring\\  the mails i got from male characters and taking only gifts from waifus for half a year or so. And this dude just give me dream solvent like WHATTT?. Should I take this rare item or not?', 'EN', 'PT'), 
    ('Take that, Gorilla!\n1st half was easy, Acheron sweeps. 2nd half, used an almost mono-Imaginary team with Ruan Mei to quickly break the gorillas and Bronya. So this is the power of a limited sustainer.The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'EN', 'IT'), 
