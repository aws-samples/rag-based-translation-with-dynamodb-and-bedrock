...
content_list = [
    ...
    ("Neuvillette is homeeeeeee!!\nI was losing hope...like I pulled for him as soon as they dropped his banner but I didn't get him  so today, the last two days before they take down his banner, I decided to grind and get ten fates to try one last time and at pity 0BOOOMHE APPEARS!! I AM SO HAPPPYYY Now, I can say bye-bye to my luck for a bit but it was worth it", 'en-us', 'ru-ru'), 
    ('Is this normal or what?\nDoes this happen frequently or ? Like I’m grateful but i genuinely am surprised to see how many people actually achieve this stuff', 'en-us', 'de-de'), 
    ('Totally not obsessed\nI absolutely love his character and boss fight (even tho he killed my dps and had to restart). Cant wait for his nova desktop animated wallpaper.', 'en-us', 'th-th'), 
    ('Daily aventurine post!\nI js arrived in penacony..I’m tl 56..', 'en-us', 'en-us'), 
    ("[Daily Sharing] Feeling Lucky? Some Eventful Ley Line Overflow Rewards.\nI've been seriously pushing for Mora Ley Lines of late, so it was a nice change of pace when today's 3 Bonuses gave me 10 Hero Wits per Ley Line, as that is the maximum amount it can give per reward usually. Thank you kindly, good fortune! I will make good use of these! 1st Reward from Ley Line Overflow today.2nd Reward from Ley Line Overflow today.3rd and Final Reward from Ley Line Overflow today.It's important to use your resources wisely, at least, that's what I tell myself anyways. Regardless, that's all for today! Thanks for Viewing! Peace Out!! ", 'en-us', 'zh-tw'), 
    ('got him!!!\nkinda sad i wanted acheron but yk it is what it is and also he’s not bad also i kinda knew that i wouldn’t get her so i still happy with this ', 'en-us', 'ru-ru'), 
    ('Buff herta\nIf cocolia freezes kafka, restart. Runs with this exact teams varied for me between 54-65k points. Took a lot of tries. Never give up. The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'en-us'), 
    ('Whyyy😭😭\nI tried pulling for neuvillettes signature but got kazuhas sword😭😭. I lost every 50/50 on my account since playing bra😭', 'en-us', 'zh-cn'), 
    ('Who hurt this person 😭\nI just wanted to use all my write bottles for the day on random notes and this person took one of my bottles way to personally. And i only made 1 bottle saying im happy with myself and they got mad about it, pretty funny, hope they are doing well.', 'en-us', 'zh-tw'), 
    ('Istg if anything happens to Aventurine I will be the next Otto Apocalypse\nTHE TEXT I GOT NEXT DAY AFTER GETTING AVENTURINE HURTS SO MUCH WAHHHHH-\nI will never be healed after 2.1 (;´༎ຶД༎ຶ`)', 'en-us', 'zh-tw'), 
    ('i’m not sure who to build\ni need to build more characters but i don’t know who or what line up would be good. i currently use stelle, dan heng, tingyun/march 7th, and huo huo.', 'en-us', 'vi-vn'), 
    ('🐈\u200d⬛ Pardo time! Some pics.\nI took videos but i hate that I can t post them there. It was so hot outside i was dying but i loved the pics. My official photos will be at Otakufest on Saturday. One of my friends are bringing Elysia so it will be so pretty to take pics with. I tried buying the Can plushie but no one is selling it. :( I hope you guys enjoy this cute pics. And thanks again for the support. I rlly want to cosplay Mobius tho. But she s so expensive.', 'en-us', 'th-th'), 
    ('Acheron/Jingliu hypercarry\nBoosted Nihility and overkilling Jingliu!The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'ru-ru'), 
    ('Cant fast travel, else im stuck in the loading screen. Anyone have a solution for this? Using a pc btw\nThis issue just came up today, and to this day it was all fine then idk what happened. You can log in just fine, get into the game just fine, but then if you try to fast travel anywhere the loading screen will be just like that theres no progress increasing at all, and when you are finished doing a battle it will be the same except its a black screen, its been so long waiting and nothing happens. I already tried reinstalling the app, check all of my drivers and its all up to date, i tried changing my provider data, clear the cache, and its still the same. Do you guys have any solution please fix and give the solution fast. thank you!', 'en-us', 'ru-ru'), 
    ('neuvillette photos!\ni finally got neuvi after losing my 50/50', 'en-us', 'ja-jp'), 
    ('About seelie Columbina theory\nIf Columbina is a seelie canonically (and so can’t love) then canon can bite me because Arlebina is too cute to just disregard.Sorry not sorry.- someone who is usually canon &gt; fanon', 'en-us', 'vi-vn'), 
    ('I’ve come to the conclusion that..\nI’m straight but Arlecchino is an exception 😍', 'en-us', 'ja-jp'), 
    ('Sparkle Cake!!!!!!!\nI made one of my fav girl in hsr', 'en-us', 'th-th'), 
    ('Tighnari the healer\nIdk who to give the credits to so if you find the owner of the meme let me know !\nBut just I love this duo so much', 'en-us', 'th-th'), 
    ("How much Fragile Resins Do yall use when farming?\nI'm just curious how much yall have prepared or used for a character u wanna build &gt;< like around how many fragile resins have u spent on 1 character ? ", 'en-us', 'zh-cn'), 
    ('DOT + Acheron Full Auto\nAuto did all the work this timeThe content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'de-de'), 
    ('Happy Birthday Yelan!\nStylish, secretive, hydro bow user, Yelan. Happy Birthday!\nI love her playstyle and animations. Seeing her in a new event or giving her another story quest would be great.', 'en-us', 'de-de'), 
    ('Bronya is a great leader\nI’m sure some people wouldn’t understand the implications of giving away your freedom in exchange of “prosperity”\n\nThis is what happened in my country. What started was a good thing, ended in tragedy and the loss of the livelihood of the many— all because we believed in a superpower and didn’t believe in ourselves. And now we suffer and our children suffer. We owe the world bank more with each president. It’s outrageous. \n\nGames and many forms of fiction display reality. I’m quite happy with Bronya’s choice and I wish to see a follow up to Belobog’s rise.', 'en-us', 'zh-cn'), 
    ('The future of Aventurine\nThe future of him is that I want him to be safe and sound and that nothing will happen to him and that he will meet up with his bestie Dr Ratio and everyone will live happily ever after. Sorry guys but I’m on copeium right now… a little drawing I did before of Ratio in my style.', 'en-us', 'ja-jp'), 
    ('An event from Honkai star rail mentioning Genshin\nVery unexpected but interesting to take note', 'en-us', 'ru-ru'), 
    ('memes review\nme with 32 fates wait for new banner', 'en-us', 'ko-kr'), 
    ('I just love Inazuma so much \nI m sad that I m getting closer to 100% in every area. It s so beautiful!\n\nI get so nostalgic for the Archon quest. I know some people have their reservations about it, but I thought it was fantastic!\n\nCannot pass by that statue without thinking of that scene with Thoma.\n\nAnyway, I did the thing!', 'en-us', 'de-de'), 
    ("Question about re-run banners if anyone knows.\nI'm new to gacha games as of last year when I started HSR. I wanted to get both topaz and aventurine for my Dr Ratio FuA team. However if I get aventurine now I most likely won't be able to pull on topaz re-run banner. If I get aventurine will I be able to pull for topaz in the future or do the characters only get 1 re-run ?", 'en-us', 'ja-jp'), 
    ('I made a bookmark!:)\nI redrew the first ever Genshin impact fanart I ever made as well❤️ If it guys want the bookmark yourself, feel free to tell me, and I ll give you a scan❤️ Otherwise I hope you all have a great evening❤️ (it s evening for me lol)', 'en-us', 'zh-tw'), 
    ('Daily Adventurine post for companionship points!\nCurrently farming for his new build, wish me luck!', 'en-us', 'ru-ru'), 
    ('got a thing\nI had to get a new phone case, and I opted out of the wallet case I usually get to get something that will keep flour off my phone screen and out of my charge port. wasn t expecting it for another few days, so this was a nice surprise. idk where to put it, so I guess discussions will do. It s on Amazon, for other Wrio stans who might be interested.', 'en-us', 'ja-jp'), 
    ('YaeMiko maid cosplay\nA few selfies from my last session. \n\nOutfit: Yaemiko maid from Uwowo\n\n\n#cosplay #yaemiko #yaemikocosplay #genshinimpact #genshinimpactcosplay', 'en-us', 'zh-cn'), 
    ('What s up with this?\nA friend of mine pointed this out and I thought it was post worthy. They look so similar so whats the deal with it? Same eyes, headband, and eyes that I can see. I guess we have to wait till 4.6 and see if this is talked about!', 'en-us', 'ru-ru'), 
    ('Don’t mind the title I’m feeling chatty today and I want to talk to people.\nI also want to give positive feedback to people ', 'en-us', 'th-th'), 
    ('AHAGSGSYAUA THEIR SO CUTE\nI LOVE CYNARI ♡♡♡♡♡ {not my art}', 'en-us', 'de-de'), 
    ("I NEED HELP GUYS\nI'm currently guranteed a 5 star on the limited banner in genshin with 42 pity and 8220 primogems.... The question is if I should pull C1 Neuvillete, Arlecchino, or a Furina. PLEASE GUYS I NEED HELP MAKING THIS DESCISION!!! (I also have a fully built amazing Hu Tao if that changes anyones opinion with Arlecchino.)", 'en-us', 'fr-fr'), 
    ('Did it with sampo cleared with 3 stars on exactly 20\nSampo: What are you waiting forAbuse the trottersThe content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'zh-cn'), 
    ('Some Aventurine memes~(PLEASE read description for those who follow me)\nOk this note is for my followers or those who expect more memes from me sooo i won t be posting for a month and a half or maybe less because my final exams are starting and i need to prepare for them(┬┬﹏┬┬). Of course, this doesn t mean I m leaving forever after I m back I ll try my best to post daily, and maybe I may come back to reply to comments（＾∀＾●）ﾉｼ and stuff soo that s it i yall have a wonderful day ヾ(•ω•`)o', 'en-us', 'de-de'), 
    ("Lyney or Arlechinno?\nPersonally, neither...The older characters are powerful AND simpler to use. Arlechinno and Lyney- while not rocket science- still seem to have self-concerned kits that make using them more of a hassle then the enemies you'll be using them against. I'm certainly looking forward to new Pyro characters. Arlechinno was the hope for a while, BUUUT she's a mixed blessing. Still waiting on the Pyro Archon, BUUUUT there's rumor that there's a very powerful Pyro character coming out...and it's a guy so cool because playing women all the time is irritating me. I think after Pyro Archon I'll just wait for characters that offer better and substantial improvements to my existing characters. For instance, if there's a Cryo character that deals good and consistent Cryo enough for better MELT teams, I think I'll pull for them if they are a 5 star. I'll never pull for 4 stars. Only exception is Archons. Gotta catch them all!!!", 'en-us', 'zh-cn'), 
    ('Day 187 Saving for Chlorinde!\nExplored more of the Chasm, got to the 70%’s! Also did some chasm quests and leylines in Liyue for leveling materials! ', 'en-us', 'ko-kr'), 
    ('HELP ME REACH 1K‼️\nI been waiting to at least reach 1k for a while now I finally have been cosplaying for a year and a half now! More content will be coming out soon ‼️ thank you so much for all the support love you guys💕🌊', 'en-us', 'ja-jp'), 
    ('Getting an Achievement without the required character(s)?\nI don’t have Aventurine but… I somehow got this achievement. My characters in battle are Serval,Acheron,Herta,Natasha.', 'en-us', 'vi-vn'), 
    ("Seirai Island\nYou all said I should touch grass and I did it. See? I have placed the camera in the grass so you have the proof I did it.Mmmm grass.I started playing again star rail so you'll probably start seeing photos of it soon. Thought I still need to know better the places so I don't get post.I really would like they add the jump button.Bye everyone and see you tomorrow.", 'en-us', 'zh-cn'), 
    ("My thoughts on the character skins that will be released on the 5.4 Lantern Rite, next year\nI believe the skins will increase in number once more next year to maybe four, five or six. The two characters I predict will get skins next year are: Zhongli and Xiao Zhongli is mainly because they have teased a character skin this year that was first shown during the story teaser during last year's lantern rite, so it's only natural that he'd get one.And for Xiao is because I still believe he'll get a skin and a character skin for him is in possibly in the pipeline. Previously, I thought Xingqiu, Beidou, Xiangling or Chongyun would get character skins alongside Xiao this year and mentioned this in a previous post. But only Xingqiu got one. Other characters that I can see possibly getting skins alongside them: Qiqi, Yelan, Yanfei, Baizhu, Yunjin, Hu Tao, Xiangling, Chongyun ", 'en-us', 'ko-kr'), 
    ('Sooo much horny weebs\nI’m surprised yet not surprised by the amount of followers I gained from just one post. Just goes to show that if u wanna grow your account substantially then post and mention thicc thighs. Where’s the no horny hammer when u need 🤣', 'en-us', 'fr-fr'), 
    ...
    ('My drawing\nNot Hoyoverse related but please support my art on Instagram, Youtube and Tiktok! <3 \n@yuanting_insta\n@yuanting_yt\n@yuanting_tiktok', 'en-us', 'zh-cn'), 
    ('Sethos Art\nSethos art I finally finished 😆', 'en-us', 'ru-ru'), 
    ("Favorite places to meet Kaeya in game\nWhen you do his quest at the beginning of the game, he's just chilling in the headquarters and when the Sumeru quest was going on (him talking to the bird was hilarious like what are you doing good sir?) ", 'en-us', 'ja-jp'), 
    ('Stage 10\n✨Important Eidolons: E2 IL✨Key Stats: Cr CDThe content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'ko-kr'), 
    ('Question about World Level\nI just ascended to WL 2 and found out, that my loot will now be better. Would id be wise then to save my keys for even higher WL or does it not affect these chests?', 'en-us', 'de-de'), 
    ('Baizhu Drawing\nThis is for the Stay Healthy art competition!\nAttached are the wips and screenshots of my layers!\nCritiques are welcome!\nDone on ibis paint', 'en-us', 'th-th'), 
    ('this fan art is so cowl bruh\nnot mine credits to the og artist', 'en-us', 'ja-jp'), 
    ('Kafka is beautiful\nShe is so beautiful, I would do anything for her', 'en-us', 'vi-vn'), 
    ('Yelannn b-day☆*:.｡. o(≧▽≦)o .｡.:*☆\nHappy birthday Yelan my pookie ╰(*´︶`*)╯♡', 'en-us', 'ru-ru'), 
    ('When you win your 50/50. (Topaz Edition)\nHow it feels when we win our 50/50.', 'en-us', 'ko-kr'), 
    ('all raidens I know\n4 versions of Raiden that I know', 'en-us', 'ru-ru'), 
    ("What sthe prettiest burst??\nI think it's either Ayatos or Neuvillette.", 'en-us', 'zh-cn'), 
    ('Not Furina friendly\nI just want my Yelan to crit cause I just want to. And I met Xiaoven person and I personally don’t like it kinda, then I like them after I played a song of Moonlike Smile from Dragonspine. I appreciate your comment! (Comment all hates you want, I just can’t wait how many comments I will receive in such post)', 'en-us', 'ja-jp'), 
    ('Roomies\nHe would probably find me a weird person or interesting maybe both BUTTTTTTT we WILL have cuddle evenings/nights (slowburn he loves me i love him we get married and get kids (cats + yanqing) then we die old and happy together) I don’t accept an apartment without a balcony and if its a house then i wanna be able to climb on the roof because yes its fancyAll in all me as his roomie is basically me as his housewife and I don’t mind (i hate work, who doesnt)tho… unlwss modern au or sum he wouldnt need a roomie or whatever bc hes probably rich and can pay stuff for himself okokokk fksbfnd', 'en-us', 'ja-jp'), 
    ('Weekly Report Competition enters\nFollow, and comment on this post to enter! I will host another competition once Termi_nator can get on his phone. (Lol)', 'en-us', 'zh-tw'), 
    ('DHIL hypercarry and Ratio/Jing second half\nDHIL brute force first halfAventurine needed to tank Boss Aventurine in second halfThe content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'id-id'), 
    ('Yummy Hu Tao wig soup\nCosplayed her a long time ago and thought about cleaning the wig since it was pretty crusty\n\nAlso Mizuki cosplay pics possibly soon', 'en-us', 'ja-jp'), 
    ('Splash Arts\nJust splash arts of the three husbands + Trailblazer\n\nWhich Trailblazer do you guys use the most? Physical/Destruction or Fire/Preservation?', 'en-us', 'ru-ru'), 
    ('What made you want to play Kafka in game?\nHer appearance and personalty definitely stood out to me when I first started the game. Plus her Ultimate looked really cool to me, and honestly stuck with me the whole game. I guess thats why I still main Kafka. What about you guys, what made you pull or choose to play her?', 'en-us', 'en-us'), 
    ('Finally i Got Kazuha 😭\nGuy s comment , how many do you have primogem💧\n\n1. Guy s Follow for Next next Redeem Code \n\n2. Go and check YouTube channel \n\n3. New started New channel channel', 'en-us', 'de-de'), 
    ('everyone know 🤭\ninspire by arlecchino animation', 'en-us', 'zh-cn'), 
    ('Literally being an aesthetic collage maker ✨✨✨✨\nI WAS BORED- anyway, do you like them? I don’t know what I did. I just made them. That’s it, nothing special :)\n\nI might actually do more of these\nIt was pretty fun honestly\nSooooo feel free to comment which characters you want me to make a small collage of! It can either be Genshin or HSR! Any character of your choice! (Might do four or five comments each post)', 'en-us', 'ja-jp'), 
    ('arlecchino 🙏\nso so so excited for her to come out, I can’t waitttt 💪 im so happy on how this drawing turned out, I managed to draw a decent side profile! bro she is so fun to drawww, especially her hair lol. don’t question why there’s no eye.. I got lazy.. 😰\n\nanyways, any time I listen to the song “little dark age” it just reminds me of arlecchino, idk why 😭👍 I kinda wanted to make a short animation using the song, but then I realized it would take me too long and I would probably forget to finish it 😔 one day im gonna get better at animating ‼️\n\n4.6 needs to come faster fr 🙏🙏', 'en-us', 'vi-vn'), 
    ("100% in Monstad! Finally! Now on to Liyue!\n#liyue #monstad #100% #finally #atlast You have no idea how long it took me to finally get this in Monstad! I'm proud of me!", 'en-us', 'ja-jp'), 
    ("Help with Co-Op teapot \nPlease help me to get this last achievement for level 3I'm ar56 NA server, and all my friends have stopped playing. You can take anything from my world if you need it.", 'en-us', 'en-us'), 
    ('Sketch a Day #253\nI did not expect to adore Kakavasha and Aventurine as much as I do now. 🥺 \n\nNow if only I have enough resources to guarantee his pull... \U0001fae0', 'en-us', 'th-th'), 
    ('Sparkle high pitch sound ult\nSeems only me noticing it and it wasn t there before a month ago I had to compare it from the other videos from YouTube\nisn t present in those videos. I just hope to get fixed soon it gives me a headache after few fights ', 'en-us', 'zh-cn'), 
    ('NAME RESEARCH parte 4: ❄️LA SIGNORA🔥\nLa Signora (pronounced [la siɲˈɲoːra]; lit.\u2009\'the Lady\') is a character in commedia dell\'arte. She is the wife of Kuba and the mistress of Alexas. She is tough, beautiful and calculating, and wears very wide dresses along with very heavy makeup. She walks with a flick of the toe and her arms held far out to the sides of her body.La Signora could be a "courtesan" (high-class **********), but typically manages to wrangle her way into the household of an old man, usually Pantalone, where she would inevitably ***kold him. She was an older, ******** experienced Colombina, known as Rosaura.(Information comes from Wikipedia)', 'en-us', 'vi-vn'), 
    ('this animation was actually so cool omg\narlechinnos backstory is so sad', 'en-us', 'ja-jp'), 
    ('Day 3\nDay 3 of posting for jingliu frame~', 'en-us', 'ja-jp'), 
    ...
    ('What’s Wriothesley’s favorite tea flavor?\nThis is not a joke. I suppose it’s black tea, since it’s like the standard kind. I’m not sure if I missed him saying otherwise ', 'en-us', 'ru-ru'), 
    ('and finally i did it!!!\nabyss 36 star after 1 year try...', 'en-us', 'de-de'), 
    ('I m not ready to level up I like being lol 69\nI need to stay level 69 don t level me up :(', 'en-us', 'vi-vn'), 
    ("Acheron had a terrible build but I just about managed\nWon't lie, my Dan Heng team definitely carried this floor. 3 cycles side 1, 7 cycles side 2. Probably should have used a different DPS since my Acheron is lacking in a good LC but I wanted to try her out. I was using a level 80 Himeko LC (because of the high base atk). One thing to note is that adjusted my sparkle spd to 173 so that the 12% spd debuff wouldn't be too effective. Aventurine's placement is also pretty important so that I could get my ultis up quicker from the energy gained from getting hit. It felt a lot harder than the previous MoCs, definitely.The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~", 'en-us', 'zh-tw'), 
    ('New blade build\nStill need to change my planar to the other set but been farming for other people. Decided to go for two piece instead of the set because kept ending up with 120 crit rate. Plus will max his weapon eventually so will get to base 70 crit rate on his next rerun.', 'en-us', 'ru-ru'), 
    ('all in\n30 pity, blessed by aventurine’s luck', 'en-us', 'de-de'), 
    ('Ship tier list!\nI m not really a shipper but I wanted to rate some ships...please if you have an opinion feel free to speak it!...I feel that there will be some hate for where I ve placed some of these ships so I apologize if any of your ships are placed in the definitely not section or the not my thing section also this took awhile but I m glad I got it finished!', 'en-us', 'id-id'), 
    ("Wanna give a shoutout to my HSR friend\nThank you for your e6 Acheron, without using her as a support, I don't think I'd be able to get Aventurine's trace materials so fast.", 'en-us', 'ru-ru'), 
    ("My luck is shining a bit too much this patch... 😃\nI didn't had any hopes of getting any 5* weapon early... Well at least something is better than nothingI was trying to get neuvi's weapon but ended with kazuha's XD", 'en-us', 'ja-jp'), 
    ('Argenti is truly a knight of beauty\nGU1K4CRA6N (My code for the share your code event lol cos I completely forgot about it then remembered im f2p i need it lmao) Anyway just did argenti’s quest and i lowkey see him in a more beautiful light, still weird for rizzing a plant, but he’s still a good guy', 'en-us', 'fr-fr'), 
    ('Cyno!\nneeded something to doodle and Cyno volunteered!', 'en-us', 'vi-vn'), 
    ("Me everytime I need to choose the sacrifice\nDon't worry, Acheron and Black Swan to the rescue", 'en-us', 'vi-vn'), 
    ('….what???? 100 follows???? 😭\nYOOO WHAT?????????? How did I get 100 of you lovely people to follow me 😭😭😭😭😭\n\n\nI never thought that I’d get to this point or even get any attention at all, so thank you guys sosososo much <3333 I say this a lot, but I really do appreciate all of you guys’ love and support!!! It means a LOT to me that my art, cosplays, and covers actually are enjoyed 😭😭😭\n\n\nIn honor of this milestone (this seems pretty big to me, idk) how about I host a Q&A? Rules are no questions about personal information (like about my age, etc)😁\n\nAsk your questions down below, if you have any!!', 'en-us', 'id-id'), 
    ('Well you accomplish your goal phoenix_c\nTysm for all the likes it means a lot to me♡', 'en-us', 'ko-kr'), 
    ('me when arlecchino gets released\ngrinded all month for her lmao', 'en-us', 'th-th'), 
    ('Mageblade corrouge\nJust spent 30 minutes of my time swimming and dodging the bubble, than attacking mageblade with XENOCHROMATIC JELLYFISH and defeated it\U0001f979😨Then googled it just to know you need to use the XENOCHROMATIC BALL OCTOPUS to defeated it faster 🥲🥲🥲', 'en-us', 'zh-cn'), 
    ('Auto team\nF2p player...Barely 20 cycles left...The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'fr-fr'), 
    ("Day 6 - Cool Pose\nY'all should try to take ei's photo using 2nd acc to explore more pose. A lot of nice shots with new angle we can get. This is one of the example ", 'en-us', 'ru-ru'), 
    ("The Knave is calling me!\nI'm sitting on my pity waiting for the father to release. Two more days just but it feels like eternity.Knave : I'm surprised you want me so much. Me: you don't know how much. Knave: bless you. Finally i shall see this image after my wish right after the update. I'm pulling her! I will there is a clock in RL, I can't wait two days.😭", 'en-us', 'th-th'), 
    ('Was casually gliding then this lil guy decided to be silly\nI literally glided by thinking “wut da fook?”', 'en-us', 'ja-jp'), 
    ("MOC 2.1\n1st team only needs 2 cycle to clear but the 2nd team....  It's not jingliu is bad but aventurine boss is so tanky ugh..", 'en-us', 'vi-vn'), 
    ("So who else is in the beta?\nI see a lot of people complaining they didn't get into the beta and that's a very valid complaint, but I want to talk to the players that got in.How are you vibing with the game? Having fun? What S rank did you get from Stable Channel?I'm having loads of fun, this game is just beautiful and the gameplay flows beautifully even if it took me the whole prologue to understand what the hell is Daze.As for my luck, it might be as bad as always but I somehow managed to pull this man, so I'll be a happy creature for a while:I mean, steampunk wolf that kicks enemies very hard. I might be turned into a furry by his existence alone.", 'en-us', 'de-de'), 
    ('i need some help yall 💀\nso im currently debating on if i should wish for neuvillette or if i should keep saving for arlecchino since i have basically farmed almost everything i can currently for her but i feel like neuvillette would make my account better. i dont mind just saving for arlecchino’s next rerun either. i dont know what i should do honestly so what do yall think?', 'en-us', 'th-th'), 
    ('ITTO ITTO ITTO\nStolen Itto memes tee hee <3', 'en-us', 'zh-tw'), 
    ('THIS SHĪT AINT FAIR\nWHY IS ARLECCHINO PLAYABLE BUT NOT DOTTORE?!AND ALSO SIGNORA BTW IDC IF SHE DIED TINGYUN DIED IN HSR BUT SHES PLAYABLE BRO DEAD PPL IN HSR BECOME PLAYABLE SO WHAT ABT GENSHIN?! WHY IS HOYO GIVING HSR PLAYERS SPECIAL TREATMENT?!AND STOP BEING LIKE "arlecchino is the best fatui harbinger!" ITS ANNOYING SHES OVERRATED AND YAE MIKO AND JEAN ARE HOTTER THEN HER SO PLS GENSHIN MAKE DOTTORE AND SIGNORA PLAYABLE ', 'en-us', 'en-us'), 
    ('Kaeya, the new elsa\nif you re girl has long hair\nmysterious eyes and an eye patch \nwears clothes with boob space\n\nthen that s not your girl, that s our Kaeya bbg', 'en-us', 'fr-fr'), 
    ('(26 screenshotted) I try to kill my friend but…\n*soak self in water anyway**thinking about something evil*yes yes few hp instant killyes yes yesno no no..damn the food whyno no no..', 'en-us', 'fr-fr'), 
    ('Silver wolf day 14\nWhat rank would silverwolf be in valorant?', 'en-us', 'ru-ru'), 
    ('130 pulls just for him\nI started saving after I got Argenti', 'en-us', 'fr-fr'), 
    ('Team Comp for new f2p\nHello!!! I was wondering if some more knowledgeable HSR players could recommend a team comp with the characters I own.', 'en-us', 'zh-cn'), 
    ("Is this good?\nHi i need help with somethingI recently got neuvillette and i want to know if my build is ok or notDo i need more CR or it's enough?I'm still farming for the talents material and i got this far for now I will level up the weapon in future i just wanna know if this one is good or notThank you for helping", 'en-us', 'id-id'), 
    ('in your opinion…\nis it worth it to go pull neuvillette if you have ayato? I actually love playing ayato but neuvi trial was rly fun. im f2p btw. and im prepared to 100% my map for arlecchino. so idk cuz neuvi is fun but I LOVE arlecchino’s design. and idk if neuvi is worth it for my account if im planning to get arlecchino and already have ayato', 'en-us', 'ru-ru'), 
    ('Best girl Chiori\nRead title (Navia best girl too ofc)', 'en-us', 'de-de'), 
    ('How my 2.1 Pulls went!\nI’m actually so happy I got Aventurine, I fell in love him with the MOMENT I heard his voice from that one call with topaz. While I am kinda pisse* that I STILL don’t have Lighting dps but Oh well ig. But still I’m happy that Aventurine is home so I can give him the love he deserves.', 'en-us', 'ru-ru'), 
    ('Dr Ratio\nGuys I want himIm such a narcissist that I just find it hot at this pointThat one lightcone with the gun… OMG Kiterally drooling like ', 'en-us', 'ko-kr'), 
    ('Best reporter and photographer ever\nCharlotte has to be the best reporter and photographer of the steambird so far cuz no one can get a scoop like Charlotte', 'en-us', 'ja-jp'), 
    ('Tighnari fanart :3\nHeyyy, I tried water colour for the first time a few weeks ago and this is one of the two works I did, I hope you guys like them :3', 'en-us', 'id-id'), 
    ('day 1!\ndidnt know there was companionship for aven tooo', 'en-us', 'zh-cn'), 
    ('Neuvillette s Signature Weapon\nI got Neuvillette s signature weapon. The last time I pulled from the weapon banner was when I got Furina s signature weapon. Is this luck?', 'en-us', 'vi-vn'), 
    ('do you ever love one man so much\nMostly free to play but I had to go all out for aven... here s to hoping Robin comes home early because he did not make it easy 🤣', 'en-us', 'ja-jp'), 
    ('Amplifying Test\nJust to have an additional draw to win nothing lol', 'en-us', 'vi-vn'), 
    ('Saving for wanderer - Day 11\ntoday was my first day off so im thankful to say i entered S E R I O U S    F A R M I N G   M O D E\n\nprimary methods were exploration (today: serai island) and story quests (today: childe s and chiori s)\n\ni realized i had two acquaint fates and wished for funsies and i accidentally got sucrose. whoopsie\n\njust with the things in my bag and like 80 resin i got her to lvl 70, gave her my nahida s lvl 80 mappa mare and got it to 90, put on my viridescent set i saved for kazuha (but retired cuz imma skip him lololol) and got her to 590EM and 150ER \n\naccidental win for me', 'en-us', 'zh-tw'), 
    ('Voice line\nWhich Nahida voicelines are your favorite? ', 'en-us', 'zh-tw'), 
    ('Best team\nCause i dont have jing liu. SadgeThe content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'zh-cn'), 
    ('I need help for a hyperbloom team\nI felt like, since I got Neuvilette recently, I should make a team of him.\nI watched a couple videos, built him a little, but what team should I give him.\nBefore, I tried running a hyperbloom team with a bunch of four stars and a Mona, which wasn’t too good, but now I have Neuvilette.\nI have a Kaveh and Kuki, which is fine.\nBut I don’t know whether I should put Faruzan or Lynnette on my team for swirl, can someone say which is better for a Hyperbloom team with Kaveh, Kuki, and Neuvilette hyperbloom team, Faruzan or Lynnette?', 'en-us', 'ko-kr'), 
    ('Co-op\nI had a encounter with an inappropriate player in co-op mode. So I am just chilling in inazuma doing quests and I get this co op request, I accept it, because I am nice. This person was SOOO inappropriate, they were acting like a friend but then things started getting weird. Like in the chat they would ask weird thing like when I was farming for one of my characters they asked if they could do "things" with me. I asked what they meant and they said, "i mean do that with you". I kicked them out and reported them. So yeah. BYEEEEE ', 'en-us', 'ja-jp'), 
    ("Alt Account\nSo, I was thinking whether I should Visit my Alt account a little bit and mess around cuz I'm bored.  But I realized, I had to logged out first. Which I'll never do! It would be a pain in the b*tt if Logging back had an Error again, like typing the password but it says incorrect.Dont wanna switch pw again.", 'en-us', 'fr-fr'), 
    ("Daily Clara post\nLike if you like Clara, comment why if you don't ", 'en-us', 'zh-cn'), 
    ('Happy Birthday Yelan!💦🛐\nOne Of The Best Hydro Characters💫\U0001f979\n\nShe s so good that I wish I had her, but I m saving for someone else(right now)😭', 'en-us', 'ru-ru'), 
    ('Dori\nDid anyone ever notice that Dori wares overalls  ', 'en-us', 'zh-cn'), 
    ('Konage’s look before she died \nShe was like this just before she died, (she snuck up to the school roof to check on a plant she was growing in secret on the roof and then she got pushed off) I tried to go for the 2000s look since she died around 2002 and her bangs are a bit different since she got her eye stabbed as she fell so she styled her bangs to hide it', 'en-us', 'fr-fr'), 
    ('A walk would be nice, but.. it rains?\nFeaturing Lady Furina and Sigewinne as students.They walked home together after the school bell rang.A few steps later, rain started to pour.Sigewinne: "Luckily I was ready with my raincoat the moment we stepped out of the school\'s gate."Furina: " A luck too when Neuvilette passed me the umbrella this morning. Like he already knew it gonna be raining."Sigewinne: "Oh, what he is doing at home?"Furina: " Not so sure. But when I left this morning, I saw he was ready to watch movies on TV."Sigewinne: "Ops..- don\'t tell me they are sad movies."Furina: "Huh?"ops- it rainsafter the rainprogress', 'en-us', 'ru-ru'), 
    ('hear me out\nHu Tao is the greatest character known to mankind because of her great personality and bcuz I said so and also because she is honestly best liyue character ok? The reason why I like Hu Tao:\nbecause I love ghost girl with brown hair and bc I’m not mentally stable and she gives me life', 'en-us', 'zh-cn'), 
    ('I need answers.....\nI get why people say she is like spider.. i can see it here. . . But then. . . Someone explain me why she have wing.  (As far i know spiders do not have wings.)( And i think i know why ONLY one wing. .. coz it is easier to play. Two wings would be too complicated - i Guess - and blok to see her desing , while exploring or in combat.)And here she looks like incarnation of pyro crystal fly.   What should i make of this?', 'en-us', 'ko-kr'), 
    ('This is really sad\nIf you are going to call me a homophobe and trash talk me, at least have the courage to keep the comment up instead of just deleting it to avoid it. (Copium Yae by Naedix)', 'en-us', 'en-us'), 
    ('Aventurine Banner Submission\nIf Aventurine would be best described by any card, it would be this one. He’s so unpredictable, buddy seems like the type to randomly slam a uno reverse on the table.', 'en-us', 'ja-jp'), 
    ('[Version 4.5] - F2P Neuvillette Hypercarry & Nahida Hyperbloom\nI recorded a video of the perfect run I shared below, but with a slightly different Furina build as I got her a hydro goblet today.\n\nEven with my WIP build, Neuvillette is a powerful hypercarry… the supports did a great job buffing his damage!\n\nI can’t connect my PS4 controllers to iPad at home without accidentally turning on the PS4, so in the end I did this with my Backbone controller and my iPhone 14.\n\nThis is the second time I’ve ever played using the Backbone so please ignore the rotational mistakes especially the struggles on the second half of chamber 3. Sometimes I simply forgot what button did what as it’s a little different from PS4, and first time plunging on this controller! ', 'en-us', 'vi-vn'), 
    ('Boothill and Robin’s song\nOk I don’t particularly ship them but if they were to sing a song together I can’t help but imagine them singing Meant to Be by Bebe Rexha and Florida Georgia Line. I seriously cannot get it out of my head.', 'en-us', 'id-id'), 
    ('Week 4 of Pick Up Lines in BottleMi\nUh oh. Albedo, get your sister! \n\n(Sorry it’s late, got busy this week! 😓)\n\nRemember, if you have any suggestions for pick up lines, let me know!', 'en-us', 'th-th'), 
    ('i have my aventurine with broken keel set but the 10% crit damage is no where to be found the effect resist is too high for the broken keel not to activate\ni think the broken keel is broken pls fix it', 'en-us', 'ko-kr'), 
    ('Got Adventurine!!\nI haven’t done Penacony but all the spoilers I see about him made me want him more (aside from his looks and being Preservation and Imaginary). I lost 50/50 to Clara so I had to go All or Nothing and used up all my jades for him. I would’ve wanted his lightcone too buuuuut… no more jades ', 'en-us', 'ru-ru'), 
    ("Question: Combat functionality or characterization? How do you choose your companions?\nTa-da! Hey, everyone! I'm the exclusive Penacony-limited Chat Trashcan!Trailblazers would summon various friends to Trailblaze with them as they travel in the cosmos~How do you select your companions?The topic this time is:How do you select your companions?Ding-Dong! Come and join the big trashcan family!Trashie FamilyRemember to change your server username into your HoYoLAB ID after you join the group~!", 'en-us', 'ko-kr'), 
    ('Archeron / Jing Liu teams.\nTesting sparkle with jingliu and aventurine with acheron. Both work decent enough!The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'ko-kr'), 
    ('Daily rant about dr ratio mischaracterization :3\n"hes racist"pls, plsplspls read the dialogue, he stated that aventurine was a slave to the IPC, as well as being from sigonia !!! he was stating a fact ( that aventurine is sigonian ) , something other characters have done, unlike sparkle who has actually insulted the sigonian RACE and not just aventurine !! :3', 'en-us', 'de-de'), 
    ('acheron daily post !!! :3\nacheron is crazy LIEK HJOW THE FLIP DO YOU LIEKE SOEUUDJWJ one slash of her sword like shes INSANE i loev her so mcuh', 'en-us', 'fr-fr'), 
    ('No Acheron. Gepard is still good.\nRuan Mei keeps the dino broken. Gepard spams ult thanks to having over 134 speed with energy regeneration rope. Finished first half within 3 cycles. Second half is hard with Jingliu and the Aventurine boss ability. Luocha is very good at keeping the team alive. Pela barely survived. Got it at the very last cycle.The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'zh-cn'), 
    ('3rd 50/50 won in a row! (:\nThank you Aventurine for coming homeee. 😩🍾', 'en-us', 'zh-cn'), 
    ("Explore and Gather\nI just want to post pictures of that time I explored the Vourukasha Oasis for the first time.Usually everytime there's a new area dropped I do the world quest first and not touching any puzzle or challenge until i have the time or necessary for me to gather primos. I reread quests and books sometimes bcs I tend to forget things and idk.. I like knowing lore.I had a lot of fun in this area. The fact that they dropped a hug lore related to khaenri'ah was such a chef kiss. I just know the upcoming Remuria related new area in 4.6 will blow me away just like Vourukasha Oasis did.I remembered one of the quest here related to Narcissenkreuz, which talked about Reneé and what they were doing in Sumeru. Even though at the time it was a huge question mark for me.I hope there will be a new world quest relating to Natlan soon. I need it! I need loooooorrreee.Before and after I explored while finishing the world quests. Alhaitham's skill truly a lifesaver when I explored this area. Never been so grateful for him on my account.", 'en-us', 'ru-ru'), 
    ("Wholesome\nWholesome HoYoLab doesn't exist it WILL hurt youWholesome HoYoLab:..........It doesn't exist guys!!!!!! ☹️☹️☹️😭😭😭😭😭😭😭😭😭😭😭", 'en-us', 'th-th'), 
    ...
    ('Fontaine, Fortress of Meropide, Piltover and Zaun\nguys are Court of Fontaine and Fortress of Meropide design inspired from Piltover and Zaun from league of legends?', 'en-us', 'fr-fr'), 
    ...
    ('Light and Shadow\nSometimes, a silhouette is all you need.', 'en-us', 'vi-vn'), 
    ('Kazuha Cosplay🍂🍁\nI cosplayed him at the AniMinneapolis convention ;)', 'en-us', 'zh-cn'), 
    ("Hello, I m back!\nHello people, I haven't posted a long time causr I deleted HoYoLab, since it was useless (I thought so) because l deleted Genshin Impact (I thought that I didn't have enough room for it on my phone). But if you're reading this, then all my thoughts were WRONG cause I'm STUPID, and I'm back. Yeah that's it.", 'en-us', 'ja-jp'), 
    ('SleepyOtaku s dtiys\nI can t shade for life😔\n I originally started this when the dtiys was first announced but then I went on a roadtrip for a while and put off the drawing because I didn t wanna worry about it too much so now it s rushed :DD', 'en-us', 'id-id'), 
    ('First Time 3 star MoC 12 Auto Battle\nThank you my Blind Queen and Direction Challenged QueenThe content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'ru-ru'), 
    ("4.6 Fatui Only!!\nLumine:why baizhu let's change that *Switch it* Lumine: there this is perfect!!!Pantalone:......Lumine: so perfect complete I rather says it's a Fatui Wishes ( This photo is not mine I just see on Facebook)", 'en-us', 'id-id'), 
    ('genshin ships per character, random~! Pt 17\ngenshin RANDOM ships for every character pt 17, Heizou, Collei, Tighnari!\n\nUpright hearts = ship it\nReverse = dont, prefer over other\n\nPart 18 will be Dori, Candace, Cyno, stay tuned!', 'en-us', 'th-th'), 
    ('New player looking for team suggestions!\nSince i’m new to the game (i’ve only been playing 2 days) does anyone have any team recs for me?  I’ve been running with the top 4 characters but i’m thinking having 2 of the same element is maybe holding me back?? Should i have 4 different so i’ve a better chance  weakening enemies?? Any tips and/or suggestions are appreciated! ', 'en-us', 'vi-vn'), 
    ('What I’m looking forward to\nVery excited to get herrrr (I have guaranteeeee)', 'en-us', 'ja-jp'), 
    ('7 Mysterious Core Fontaine\nMysterious Core is a Quest Item obtained from chests after completing 7 Pneumousia puzzles. They can be submitted to Henri to start the World Quest Still Mouthwatering!.\n\nJika kalian kurang paham kalian bisa cek full guidenya di channel youtube Sensei impact ,cek link di bio atau Dm admin untuk videonya.', 'en-us', 'de-de'), 
    ('Art Block :(\nHad art block the past couple of weeks so I tried doodling again for the first time in a while <3 \nI don’t think it turned out too bad but I hope to return to making Genshin/star rail art soon', 'en-us', 'zh-cn'), 
    ('🧃Shigure Kira,Fu Hua FOV and Ai-chan icons🧃\n-Icons edited by me💞\n-If you need icons of a specific character i am here🌟\n-Official fan art and trailer from mihoyo/Honkai Impact᯾', 'en-us', 'th-th'), 
    ("STANDARD BANNER IS INSANE!!!\n3 five stars in a single 10 pull?!!!! Tbh I was so disappointed thinking I had gotten Clara's lightcone and then boom Another one and ANOTHER ONE  Let it rainnnnn Ps: yaaas Bronyaaaa ", 'en-us', 'zh-cn'), 
    ('My Current Team❤️\n my current team Im super in love with luocha his healing is out of this world even at E0.so im curious Who are your favorite party member? Let me know below ', 'en-us', 'th-th'), 
    ("Blessed Avgin - Aventurine\nNote: It's been quite a while since I have uploaded, but I plan on releasing some more photos in the near future from both HSR and GI.  My take on Aventurine: I started off thinking of Aventurine as an okay character, but as his story developed, I started to like him much more, and now I am an avid Aventurine main. He also somehow made my luckiest banner pull with coming home at 75-ish pity (guarantee), then coming home again right after - literally back-to-back, Aventurine then the next pull Aventurine again. I've never had luck like that before and probably never will again, but now he is E1 and I am a very happy main.Aventurine wanters will be Aventurine havers!", 'en-us', 'th-th'), 
    ('Got him\nGot him in 4 single pulls and his cone and 2 pulls ', 'en-us', 'zh-cn'), 
    ("Neuvi  tism\nI mean, he doesn't really understand human emotions and he infodumps about water.Also, I'm autistic myself, that's why I like to headcanon him as such too.LOOK AT THISBro is sensitive to the taste of water.His soup is almost all water, and it surely doesn't have much flavor either.This? Autistic to me.Thank you for coming to my TedTalk  ", 'en-us', 'zh-cn'), 
    ("Happy 1st Birthday Star Rail!\nLink to event + fun coloring book page: Stellar Jade Reward — Let's Draw a Cake Together! Honkai: Star Rail First One-Year-Anniversary Event~  Happy anniversary! Eat cake and be happy ", 'en-us', 'zh-cn'), 
    ('When you think you have cried enough about Aventurine, but then you read his 3rd character story 😭\nNo wonder he doesn t get close to anyone.\nHis luck really does seem tocome at the price of others. 😔\n Let our baby be happy please ! 😢', 'en-us', 'fr-fr'), 
    ("AH !  I   M SORRY\nFor clearing up one of my last posts, the bathtub one..!I found it online and wanted to post it here. I didn't know it was fake. Sorry if I spread mis info 😅 but at least I go almost 100 comments...  still, hope ya'll who wanted to be in that bathtub commoission an artist 🎨 💅 ", 'en-us', 'id-id'), 
    ('EEEEEEEEEE\nwhy did my eraser disappear the moment I didn t feel exhausted and wanted to start drawing????? \nalthough, doing it without an eraser made me draw even more faster, wth', 'en-us', 'en-us'), 
    ("Best F2P sword for Furina ?\nI'm Currently using Harbinger of Dawn on Furina for CRIT DMG & that occasional crit rate. Here's my current build, what do you think is best for her ? if it's worth it then i was thinking of that fontaine fishing sword but idk if current one is best for me as it provides good crit for the current build i have.i'll be using her mostly with either Neuvillette or Raiden in Spiral Abyss.Current Furina build with Harbinger of Dawn 🌊Harbinger of Dawn R5 Lvl 90should i fish for it's R5 ?idk if it's good if i want her in Raiden dps team", 'en-us', 'ja-jp'), 
    ("Another day for Neuvillette Post\nThis is Neuvillette's Constellation, I'm just wondering if the other Dragon Sovereigns are still alive and will be playable in the future. Will their constellations look like this too?", 'en-us', 'ko-kr'), 
    ('Thank you for a 100 followers!!! (Q&A)\nSorry for not posting often I got swamped with like 4 different projects at school but rn I have a breather. :’) THANK YOU FOR A 100 FOLLOWS. I did not think this would happen so soon, I just wanted to post some of my random art and have fun here. So this post is gonna be a Q&A commemorate this achievement!  Feel free to leave any question in the comments below :D but if it’s too personal I will give a vague answer cus internet safety ;-; also if you wanna leave a small drawing request here feel free love you guys, I hope that today was a good day for you <3', 'en-us', 'zh-tw'), 
    ('Rainbowwww🌈\nI was going to ascend my Zhongli and wanted to find a nice place, I never knew there were rainbows in the game😭😭', 'en-us', 'ja-jp'), 
    ('New Redeem code\n5AJTZPPMN8VBBTKBH6P47B77Free 150 stellar jade👌', 'en-us', 'vi-vn'), 
    ('who was Acheron talking to here?\nI had assumed this was on her planet but that wouldn t make sense, because (I thought, at least) that everyone on Izumo had died?', 'en-us', 'th-th'), 
    ('so i just started building my gaming\ntook me several tries to clear 12th floor because i am still not used to his gameplay but is he always this strong omg  even with low crit ratio and low talent level ', 'en-us', 'ja-jp'), 
    ('Arlecchino banner ritual guide\nFollow the step and to win 50/50', 'en-us', 'ko-kr'), 
    ('FURINAA\nDon’t worry guys! She’s just overflowing with Hydro…\n\nInspired by silent film makeup and that Focalors design by phosfulate on insta', 'en-us', 'ru-ru'), 
    ('Black Swan but Darker\nImagine how terrifying it would be to have Black Swan as an enemy as an ordinary person, someone who is not only powerful but is capable of playing with your mind.', 'en-us', 'zh-cn'), 
    ('this quest is actually so good\nneko is a cat (for anyone wondering)', 'en-us', 'id-id'), 
    ('AHH\nDoes anyone know artifacts for layla that are really good so her shield actually works because i can not build characters ', 'en-us', 'vi-vn'), 
    ('OTTO WHY\nAS A LUOCHA MAIN I AM OFFENDED', 'en-us', 'id-id'), 
    ('What are you most excited about in 4.6?\nPulling Wanderer! Yeah I know To Vets that are seem crazy when there\'s a brand new character with a brand new weapon type (at least that was supposed to the case wasn\'t it? Scythes were being introduced and Arlecchino would be the first Scythe user, or did that turn out B.S and her "Scythe" is basically like Chiori\'s "Dual Weilding" I got hyped about and is just an aesthetics illusion and she\'s just a spear user with a Scythe looking weapon?But yeah, to me Wanderer is just as new and fresh as Arlecchino and find his backstory story extremely interesting, he\'s kinda loke the traveller, the one other soul who doesn\'t belong in this world (I mean you *could* argue Albedo doesn\'t but I\'d disagree, and I mean Lumine\'s around SOMEWHERE where I am in the story but Aether seems to have pretty much forgotten he had a twin sister (Paimon is gonna play the classical Lucifer role of charming, Cherub faced innocent pulling strings in the dark, I betcha! Even her hairband is reminiscent of the \'falling star\' as Lucifer was cast down. Lucifer "Morningstar" - "Lightbringer" Or maybe it\'s my morning 90mg Methadone and Clonazepam talking ', 'en-us', 'fr-fr'), 
    ('Filler for companionship rewards\nEven that aside, shoutout to the guy that somewhat carried me early on in the game for DPS options, even at MoC. Planning to build him later to start the cycle again.', 'en-us', 'en-us'), 
    ('Filler post for companionship rewards\nI recall being early on and struggle to beat stages and Jing Yuan support character system helped me a lot. Cheers.', 'en-us', 'ja-jp'), 
    ('Version 2.1 pull chart\nSo how was your pull going? \nit s a really unlucky version for me since I always hit 80++ to get a 5-star 😭😭\n\nI will use daily scrap jades to pull one-by-one for Aventurine. If he s still not coming then \\ Farewell, Kakavasha!\\ ', 'en-us', 'th-th'), 
    ('im tired\nthis is sadly my best artifact :(', 'en-us', 'zh-tw'), 
    ('Arrlecchino will come soon! Arlecchino will come soon!!\nI listened this short event woth headphones. I could hear those stairs cracking into my brain after they went throw my ears No one:Arlecchino: X_XThis mini-movie got me, not gonna lie! It hit me with the chills and tons of questions!', 'en-us', 'ru-ru'), 
    ("Funny/nice Bottle Mi responses\nPs I did ask for permission to use the responses!One a question I don't have a screenshot of is who is your fav Landau sibling and why?", 'en-us', 'de-de'), 
    ('Aventurine wearing the same outfit as npcs\nBro has the default worker outfit 🗣️🗣️', 'en-us', 'zh-tw'), 
    ('Will Aventurine Come Home or Not?\nHhhHhhhhmmmmMmmmmm. I am about 60-ish pity, since I can t get Acheron in my main account, only her LC. If I lose, I ll pull for Robin/Boothill or the reruns (if the rerun is Huo Huo). Anyway feel free to friend me (ASIA).', 'en-us', 'th-th'), 
    ('FIRST TIME FULL MOC CLEAR \ns/o to my boy Brandidon for help 😎The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'th-th'), 
    ("Rip and tear\nI should really build more characters so I don't use the same ones over and over...The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~", 'en-us', 'ru-ru'), 
    ('I like my cakes how I like my men-\n-Imaginary.\n\n\nHeh.\n\nCake attempt with references to three of my favourite Imaginary boyos! Pretty last minute because that s just how it goes sometimes. \n\nHappy 1st anniversary to HSR!', 'en-us', 'zh-cn'), 
    ('Aven Companion Day 3\nRandom pic with chest\nTaken on: 17 Apr 2024', 'en-us', 'th-th'), 
    ('My Rosaria and Eula Build\nThese 2 and Yelan are my favorite characters but this Rosaria build has been a great with supporting both Eula and Yelan. This build allows for Rosaria to keep her ultimate active as much as possible which boost the team s crit rate. Additionally while paired with Eula or another cryo character, it applies constant cryo damage which boosts the crit rate further due to cryo resonance. On a good run, it is possible for me to clear Eula s artifact domain in as fast as 10 seconds, and Yelan s in 15 with these builds.', 'en-us', 'ja-jp'), 
    ('Who to pull based the character I have\nGuys that all the characters I have and I have 2 signature lightcone of Kafka and archeron so who should I pull aventurine or fu xuan?', 'en-us', 'fr-fr'), 
    ('DAY 11 OF SAVING FOR WANDERER\ntechnically not saving for HIM. \nbut for his cons/signature weapon, so yeah...—\n\nBABYGOWRL ILL SPEND EVERY SINGLE THING FOR YOUUUU-\n\n\\t\\t\\t\\t\\t\\t\\t~`•Stay Nice•`~', 'en-us', 'vi-vn'), 
    ('Furina in Co-Op\nI did co-op to fight my boyfriend- i mean that totally not cute big puppet thing ()  and we won! My Furina may or may not have been the only one to survive the ordeal but that’s okay!  I’m a great teammate.', 'en-us', 'ja-jp'), 
    ('I FINALLY GOT A COPY OF AVENTURINE\nI lost my 5050 to Yanqing at 71 pity and pretty much lost hope, but I grinded for like 4 days straight, scrounged up about 20 pulls, and was able to get him at about 30 pity! No more trailblazer copium build yay :D', 'en-us', 'de-de'), 
    ("😭😭\nPov : you wanted neuvillette's weapon ", 'en-us', 'ja-jp'), 
    ('Day 18 posting Yanfei pics from the archives (Featuring Nilou!)\nYanfei s trying the power of TCG invitationals to manifest a Nilou re-run announcement for 4.7. Please and thank you Hoyoverse!', 'en-us', 'th-th'), 
    ("After not playing for 5 version. I Got this (it was sad for me..)\nGot Acheron before her banner ends but don't have  pulls saved up for adventurine. Clara on Standard. So sad, still no Bronya. I hate Clara. And finally, good things doesn't come for me, Since I'm not in the game for 5 versions there's many content to grind, I grind but lose 5050 on Adventurine banner (took 82 pulls, it's sucks right? Almost hard pity), totally got scam by Adventurine to go all in to get big", 'en-us', 'fr-fr'), 
    ('this event is about turning honkai beasts into food !!\nyeah, the honkai beasts, consecrated honkai lifeforms that turns people into zombies just by standing next to them, in oxia they get turned into food for its people to eat.oxia people are built differently. ', 'en-us', 'ja-jp'), 
    ("Hsr ships I hate part 2 (desc)\nAgain, it's about ships, not shippers so don't sh*t yourselves if here's a ship that you like, it's just my opinion about shipsI kinda like reading dramas in the comments so do y'all want me to make version with ships I love? ", 'en-us', 'zh-tw'), 
    ('I can t beat MOC 10. I need tips.\nThose are all my characters that I use. I swapped out Silver Wolf for Bronya. Can someone give me tips on how I can improve.', 'en-us', 'id-id'), 
    ('Is he good with aventurine?\nI lost Jingliu 50/50 and now im stuck with choosing either Him or Dr Ratio. Im trying to make a 2nd team for MoC and PF', 'en-us', 'ru-ru'), 
    ('Fun times vs annoying mechanics\nA good solution to the challenging mechanics of this boss, with some breathing room for gamba phases.The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'ru-ru'), 
    ("Fischl. 8-11-11.\nAnother wave of upgrades for Mein Fraulein! Another one! ANOTHER ONE! And now she moves up to 8-11-11. Thus do I have a new project alongside Furina's final crown: getting Fischl to 9-12-12. All that is needed is mora and philosophies of ballad: all 36 of them.", 'en-us', 'fr-fr'), 
    ('Charlotte s picture taking\nAka Charlotte s journey in Fontaine', 'en-us', 'vi-vn'), 
    ("Please help me!\nHi guys, newbie here and I'm wondering what team composition to use and how to properly build them. I currently use Neuvillete, Xianling, Barbara and Razor/Sucrose (I'm helpless). Any help can be appreciated! Anyways, here are my heroes currently. ", 'en-us', 'en-us'), 
    ('WHAT THE HELL\nMy friend said  moist  so I said  moist  then I waited for her to say  moist  so when she didn t say  moist  I said moist again.....THEN SHE SAID \\ NO\\  THEN \\ NO MORE MOIST\\  THEN THIS HAPPENED.....I DEAD', 'en-us', 'ja-jp'), 
    ("Storage\nHoping my storage doesn't dieAlso hoping my PC can run it cause if my phone can't, atleast my PC might be able to 😓", 'en-us', 'ko-kr'), 
    ("Yanqing slayed / welt with stolen artifacts ...\nDon't know what to say just that yanqing carried the team ! The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~", 'en-us', 'th-th'), 
    ('Klee!\nKlee is one of the cutest Genshin characters with an explosive backstory! I just love her! But... I do miss her previous VA and walking style...', 'en-us', 'id-id'), 
    ('[HSR] SamPard Highschool AU\na silly little comic of sampard I made a while back\ninspired by art made by @/foxspritezz on twitter\nand on twitter I have many more stuff but it s not important now lmao', 'en-us', 'zh-tw'), 
    ("Today I wanted to play with different brushes \nSo Kokomi was today's victim. I tried to draw a lightning strike in the back (since Inazuma is all about storms and stuff like that) but well it didn't turn out as good as I expected it to be but whatever", 'en-us', 'ko-kr'), 
    ('Journey to 1000 Pulls in F2P! Day 124\nI m currently trying to finish the Sumeru desert for good. It s been annoying me and I can t wait to start in the Sumeru Forest :D', 'en-us', 'ru-ru'), 
    ("HELP ME GET ARLECCHINO\nSo I just got Kazuha and I really want Arlecchino I need help exploring so if you could give your discord in the comments I would be extremely grateful. Ever since I saw Arlecchinos animation I've loved how we play her and she is my favorite character, I would hope to snag her and r1 but just her is enough. Thanks in advance!!! ", 'en-us', 'zh-cn'), 
    ('Why is the hsr icon... um..\nWell, after I ghosted hsr for months on my pc, I noticed this little detail, the corner of the icon is.. yeah. I don t know what the heck, but hoyo never does this\n\nWHAT IS HAPPENING\nDO I HAVE A VIRUS', 'en-us', 'ja-jp'), 
    ('Done with achievements\nFinally after 3 years,I have completed all achievements till 4.5, and now 4.6 is just around the corner. The hustle is not gonna end anytime soon haha', 'en-us', 'zh-cn'), 
    ("Aventurine or Ruan Mei\nI have 15k jades rn so I'm in a dilemma as to pull for our boy Aventurine or should I save for a rerun character which is most likely ruan mei. I am definitely getting firefly when she comes out so I reckon I can only get 1 of those 2 limited character in order to have enough jades for her. I enjoyed Aventurine story and character but I also like ruan mei mummy vibes and her kit is also so good especially for the SU ruan mei occurrence. Side note I am able to clear the current and previous moc 12 3 stars though I had to grind the rng for this current moc to prevent 1 character from taking too much damage ", 'en-us', 'zh-tw'), 
    ('Spending 1100 days in Genshin Imapct ✨\nIt is a honor to play Hoyoverse game for this long and continue to play it till the end...We love you Hoyoverse, no matter what <3', 'en-us', 'ja-jp'), 
    ("Whyyyy does my genshin burnout have to overlap with the time I need to save for Arlecchino 😭\nI wish I could pause time because I haven't played genshin in months but I need Arlecchino soooo badddddddddd but not badly enough to load up the game and then I'll be so upset because the moment I get the energy to play genshin again it'll be right after her banner ends", 'en-us', 'ja-jp'), 
    ('Silver Wolf 🐺💗❤️ (Coser: SISO 小夕)\nCoser: SISO 小夕\nCoser twitter: https://twitter.com/xisaw_\nImage source: https://twitter.com/xisaw_/status/1781296080946372640/photo/1', 'en-us', 'id-id'), 
    ('Swan diving into achievement hunt\nFor this one I recommend using the current forgotten hall stages since so much dot in them that getting 20 stacks off of swan should be easy', 'en-us', 'th-th'), 
    ('Adventurine and Archeron Account Changers💯\nMy 1st time attempting MoC 12 went well with this team.. Feels good The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'ru-ru'), 
    ('Elegant Ayaka ❄️ (Art by 椎名樱雪)\nArt by 椎名樱雪 on Pixiv, please go check out and send loads of support to the artist! \n\nSource: https://www.pixiv.net/en/artworks/117741073', 'en-us', 'fr-fr'), 
    ('.\nwriothesley and clorinde best duo frfr', 'en-us', 'zh-cn'), 
    ('F2p team\nClara is really good at gambling.The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'ja-jp'), 
    ('slay\nxingqiu best support man like seriously ', 'en-us', 'th-th'), 
    ('Sir that is a Child…..\nAm I really doing this to a literal child!? Making a servant out of a child. This sounds like…..if you know you know.', 'en-us', 'ko-kr'), 
    ('Amrita pool\nI just got 600 primgems from making all the offerings of plume of purifying light which is only 36 you don t have to spend much time it s in the surrounding area only if you still haven t collected yet than than missing out on 600 primos (complete quest khvarena of good and evil before making this offering) \nbest of luck with farming', 'en-us', 'en-us'), 
    ("Pay Attention To The Event\nWhile promotional events rotate in and out of Honkai: Star Rail all the time, there's a good chance if you're paying attention you can earn a\xa0lot\xa0of\xa0Stellar Jade\xa0and even\xa0Star Rail Passes\xa0and\xa0Star Rail Special Passes\xa0just for interacting with the game. Requirements will change depending on the current timetable, but often you'll only have to login to earn rewards, which can lead to multiple free pulls.FOLLOW FOR MORE", 'en-us', 'en-us'), 
    ('yay\ncyno + tighnari best duo frfrfr', 'en-us', 'id-id'), 
    ("got 1186th today 🥳\nI thought I need to get all experimental drinks to get this achievement. There are 8 experimental drinks and I got ED#1 (+ salt, carbonated, og state)If I get the dc again I'll try getting the rest and see if there's another hidden achievement ", 'en-us', 'vi-vn'), 
    ('my kazuha pull!\ni got xiao at pity 30 after i got Jean, which im happy bcs i got him at early pity but lost my 50/50 at kazuha banner hurt a bit, it s fine tho since it s qiqii (see ya at the next banner kazuha :D)', 'en-us', 'ja-jp'), 
    ("Imagine what Aventurine would be like in his daily work!\n I feel like Aventurine prolly starts his day by planning out everything for the day ahead. He'd walk around the place with confidence, wearing a smile that hides his true thoughts and intentions. If there's a meeting, he's likely the pne encouraging everyone to think outside the box and come up with new ideas. At the end of the day, he'd prolly feel satisfied knowing he made smart decisions throughout the day.Ps: I'm new to HSR and haven't done his story quest yet, but absolutely love his gameplay! ", 'en-us', 'de-de'), 
    ('Magical place ;\u2060)\nSuch a beautiful place don t you think? :D', 'en-us', 'fr-fr'), 
    ('Day 7 Saving Primogems ( April 20 2024 )\n4796 primogems, 5 rainbow fate, 33 blue fate, AR27', 'en-us', 'th-th'), 
    ('STELLE — — AVENTURINE — — swapping clothes series give a name\nanyways I’m sorry I didn’t post much lately I was busy with exams anyways here’s a stelle and aventurine I don’t ship them this is so risky please I’m sorry aventurine topaz shippers and aventurine ratio shippers\n\nY’know this was so risky to post bc I know those shippers are gonna go get pitchforks. Anyways Im gonna start a series called (changing clothes series and unrelated to ships)\n\nAVENTURINE COME HOMEEEEE', 'en-us', 'zh-tw'), 
    ("Acheron relics\nHi there so all I want to ask is that can you guys like send me a pic of like an Acheron relic setup? What I mean by this is like what is the literal best setup from the main bonus to the extras. So what would be like a good bonus in the extras in a way like for instance it's like 2 ATK 1 crit dmg and 1 crit rate, stuff like that.", 'en-us', 'fr-fr'), 
    ('Arlecchino Please Come home 😭\nSaving for Arlecchino Day 20 after getting Kazuha on pity 76. TBH I m always at red pity. 😭 Just please for one just please Hoyo gime ‘Father’ Arlecchino at soft pity I BEG YOU', 'en-us', 'zh-cn'), 
    ("Childe in Hoyofair !!\nI know I'm late and it's been quite long since this came out but I'm still obsessed with it !!I mean he looks so good, he's a pretty boy ! I'm so happy because we got so much fatui content lately and I love them so much, it's my special interest so yeah this is everything for me !And here he's with Father !! Arlecchino !  Hoyofair gave us content for two Harbinger as the same time ! It's been so long since we had someAnd Childe, the outfit he was wearing is incredible, just look at the concept art :MY PRECIOUS It just look so good on him !! The color, the pose, the shirt, his name written on it, the pants, everything.And also it's the second time we get a rockstar Childe with this colors scheme MY BOY LOOK AT HIMAnd notice how he handsome in both of them ! My boy's just so perfectThat's all ! I just wanted to make a post about it because it hasn't left my mind... Thanks for reading, go read Childe's lore now !", 'en-us', 'ru-ru'), 
    ('He s so goated in game guys pull for aventurine\ni use blade, ratio, aven, loucha team, is it ok???', 'en-us', 'ja-jp'), 
    ('In the recent polls\nBaizhu was in the lower ranks. But before his release, people were excited and hyped for him to be playable.\nAnyway, I started liking Baizhu s character from his story quest. That s the most beautiful story quest of all.\n\nPS. This is just my opinion but the personality of the Eng and Jap VA are so different from each other.', 'en-us', 'de-de'), 
    ('EARLY PITY AGAIN!\nwell, after losing to Acheron s banner 2 times in a row I feel like I deserve this...\n\nI got him at 9 pity, Acheron E1 on 4 pity and her lightcone on 10 pity. I got Jingliu guaranteed at like 76 pity\n\nbruh it s hard when you are only a f2p player and a newbie', 'en-us', 'zh-cn'), 
    ('Who s Excited for Robin?🤩💜\U0001fa75🔮🥺\nComment down below if u are excited!🧐👇🏻✨', 'en-us', 'zh-tw'), 
    ("Please help me with building Yaoyao for hyperbloom!\nI want to run a hyperbloom team with dendro mc , Yaoyao , Xingqiu  and Shinobu .Dendro mc is running 4pc Deepwood. Should I give Yaoyao 4pc Deepwood too? Does the 4pc passive even stack? If not, then what should I use on her? Will 4pc Gilded Dreams work on her? Or is 2pc 2pc em more preferable? Or maybe 2pc hp 2pc em?Also, should I run double dendro or should I switch out Yaoyao for someone like Raiden instead?I'm only now deciding to test out dendro teams, since I was pretty content with my mono anemo or vapourize teams so far lol. All I know is that I should stack em for dendro teams and that's it, so any and all help will be much appreciated ", 'en-us', 'th-th'), 
    ("Hardest MoC yet.\nI had to use Pela's skill a lot in order to clear this.The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~", 'en-us', 'vi-vn'), 
    ('it s complete\nThe last imaginary member finally came home', 'en-us', 'ja-jp'), 
    ('Happy update\nladies, gents and non-binary friends, I got him', 'en-us', 'th-th'), 
    (' Catalyst For Life \nSAUCE: A funny screenshot I took when playing Honkai!\n\nEditing some of these on the phone is tricky, usually the more \\ edit intense\\  poorly made memes I work on the iPad s pro create, but I only have so much spare time... \n\nI even missed the window for a funny Geo joke, well I guess I can use it on the next Geo release.\n\nEdit: Forgot to mention the whole \\ jab, jape, or  joke \\  is that every now and then when streaming someone tries to sell me their artwork, it s really weird. especially since I ve added it to the \\ first time chatter\\  rule box to say \\ yah don t ask for socials or sell stuff\\ ', 'en-us', 'th-th'), 
    ('Are these stats good?\nThese are my stats for neuvillete. He has around 37.5k hp w hp%/hp%/cd% with the mh 4pc set and ballad of boundless blue weapons\n\non a side note should i get his signature weapon as well with these stats?', 'en-us', 'vi-vn'), 
    ('Day 57 of Posting a Homemade Meme Until Hoyo Makes me a Voice Actor\nWant Jinglius lightcone this rerun…', 'en-us', 'th-th'), 
    ('Pulling for who\nGuys any suggestions who should I pull', 'en-us', 'ja-jp'), 
    ('❄️Ayaka in idle mode, she is so cool~\nI remember meeting her and how her beautiful dance captivated me. \nWhat a memorable and noble performance. \nRecently, I ve started playing her again! I ve missed you. I caught a lovely shot of her in idle mode, observing Ayatos Haran Geppaku Futsu, his main weapon.\nI let her borrow it for a moment before giving it back to him.\nFor today, I ll be Travelling around, floating calmly in Fontainian waters, perhaps some gently walks along the Mondstadt cliffs, or even back at the forge backing a couple of homemade weapons, perhaps Finale of the Deep or... Tidal Shadow. \nWho knows what else! But what can be guaranteed, I ll be sure to return to Wangshu Inn afterwards to eat a little almond tofu and maybe brew up some of my own minty fruit tea. 🍵', 'en-us', 'th-th'), 
    ('ShouldI do Ship art?Apparently its a bit controversial 😭\nI’ve made like one chilumi post in the past but i do have some other ships i enjoy… but….Ive seen quite a few fights over the topic of shipping though and i dont want to anger anyone 😭😭 what should I do? (Header pic for attention)(might chicken out and delete the post idk)', 'en-us', 'th-th'), 
    ("Sad.How I been\nTo those who did or didn't care on how I was doing honestly it didn't really matter I guess I'll just go in a debt we all know life sucks right", 'en-us', 'zh-cn'), 
    ('My opinion in character s redesign/fanart\nY\'know.. you\'ve probably seen many artists,redesigns etc. changes character\'s real skintone..I saw many good art and redesign but like.. changing character\'s skintone is not a good thing for me tbh...I saw a few redesign and they changes character\'s real skintone.. like- They even claim the half of the comments are being \'rude\'.But.. half of the comments are actually spitting \'facts\' and real \'truth\' on their art..They changed the design and it\'s alright but the skintone is not giving.. .People be mad MADDD if artists changes dark skinned characters and turn them white- BUT if the artist changes light skinned characters and turn them black.. "oH yEaH it\'s OkAy"..like seriously???- .I\'m not being racist but- what\'s the purpose on hating whitewash if blackwash could get away with it. Use logic please!.I know this is a GAME but- it has cultural relations and I think it is NOT OKAY to change character\'s real skintone.. Why can\'t some people appreciate the original skintone? Is it hard?? Is it difficult?!.Just- think logically.. not all characters from specific area are SUPPOSED to have the skintone you are expecting...I\'m completely disappointed by some of the community that went too far with art/redesign...It\'s just not fair and equal y\'know? ', 'en-us', 'fr-fr'), 
    ('WHY Fortune slips are key (Screeching rn)\nI’m screeching\n\nGuys narukami shrine is the way to get early 5 stars in 50/50s\nI got you 5 pity after raiden and Neuvillette 5 pity after kazu on days where I got great fortune. Similarly, on a day I didn’t I got a weird tall red Nahida.', 'en-us', 'zh-cn'), 
    ('itto s long last brother\nItto and Tengen would be besties tbh', 'en-us', 'zh-cn'), 
    ('Sumuru ending theory\nSo I was watching a bunch of old genshin content and I found the trailer where all the harbingers were introduced and the iconic scene of doctore near the buring irminsul tree and I was confused on why they\'d show that but not put it in game so I did more deep diving.In another post we got what each of the final acts for each region would be called and sumuru final act is supposed to be "truth amongst the table of pruna" but the last one we had was "akasha pulses the kalpa flames" which does not seem to match upIt would make sense now cause there adding in the next cyno quest which seems very mysterious and with all the odd kanierh items that we have seen in sumuru it seems a bit unfinishedAgain this is only my theory so what do you all think of it?', 'en-us', 'ja-jp'), 
    ('Savings :3\nReady to b stepped on by cappuccino', 'en-us', 'ja-jp'), 
    ('Day 13: That would certainly be interesting.\nHe would keep posting about current investigations, promote Serval s stuff oh and don t forget that he would constantly be trolled by Sampo in his comment sections.', 'en-us', 'vi-vn'), 
    ('Should I sacrifice her atk to get higher er and change her weapon to favonius?\nHow much er is good for shenhe?', 'en-us', 'ja-jp'), 
    ('Day 11: Water/Anything that isn t water.\nI wholeheartedly believe he will shrivel up and die like a raisin if he ingests anything that has less than 50% water in it.', 'en-us', 'id-id'), 
    ('Delusional or just Unlucky??\nIs it just me or does HSR keep getting harder for no apparent reason? I mean like, I\'ve used the same team comp for SU, Swarm, and Gold And Gears and I feel like they\'re just not dealing the same Damage as before. I\'ve upgraded my talents for wach but that still didn\'t work, I\'ve tried to level up relics but due to my insanely bad luck, all of it rolled to Def. Even with my DHIL Swarm was so easy but now it felt like a huge pain in the ass. Not to mention the rng of this game, again is it just me or if I either pick a path, either I get insanely lucky and get all blessings from that path or I get insanely unlucky and get every blessing other than the specified path. It clearly says there in the description "Increased Chance of obtaining blessings in *This specified Path" for example, i choose Remembrance, but then I get Nihility, Destruction, Hunt, even Preservation but not Remembrance itself?? It feels like the game is watching you and intentionally does not want you to get the blessings you need', 'en-us', 'de-de'), 
    ('UPDATE! Got Kazuha as well!\nI got Neuvillette at 24th pull. I had around 40 fates left and I went for Kazuha after saving some more and lost the 50/50 at hard pity (80 something) and got Keqing. \n\nThat was 10 days ago. Since then I saved like a mad man & got Kazuha finally at 81 pull 🥲. In process, I 100% explored 3 regions of Fontaine. \n\nNow I am gonna save for Natlan characters.', 'en-us', 'de-de'), 
    ('posting for points! (day 2)\nalso drew a simple sketch cuz why not~', 'en-us', 'ko-kr'), 
    ("Siobhan\nOriginal artist: -Yue-I see that we don't have a topic for this Lady who is as cool as Serval. Let's fix this. (Siobhan is cooler IMO, but I'm biased, so let's trust March on this and follow her opinion) Source:https://yue62170.lofter.com/post/201d88d1_2bb80dbab", 'en-us', 'ja-jp'), 
    ("HELP NEEDED!!!\nGuys! I just lost my bird who was my birthday gift and one of the only gifts my late mother left. Im having a hard time trying to overcome his death and am really depressed cuz he was not a pet, he was my companion, my family. Im a hardcore but I'm still screeching after 3 days. Cause of death: Annoying, spoiled, little brother to whom you can't even touch, if so instant death.Got any recommendations on how to calm my emptiness?", 'en-us', 'th-th'), 
    ('wip Aven\nI love aventurine sm but here s a wip', 'en-us', 'ja-jp'), 
    ('Yao Yao Genderbend !!\nhere s yaoyao!! \n\nsorry this took so long, I was genuinely stuck in what to do with her, and to me her hair looks off but I wouldn t know what to fix anyways, but I like how the pants turned out!! still pretty girly, but hey, can t really see yao yao changing a lot anyways.\n\nalso a little disclaimer, i am still learning! I ve been seeing so many positive comments, and I am so grateful for everyone who s been so nice to me while im figuring this stuff out <33 \n\nas always, requests are open!! been getting a few of them, so warning that it might take a bit ^^', 'en-us', 'ja-jp'), 
    ('profile pic\nThey (HoYoLab moderators) approve this picture of Gallagher after his yawn as my profile picture here in HoYoLab. \n\nThanks and nice!', 'en-us', 'ko-kr'), 
    ("Spiral Abyss 4.5, Nilou and Alhaitham Floor 12-3\nbaizhu tried to save furina and those 2 dancer won't let him... 33hp baizhu, the lowest that i've ever got meanwhile zhongli with his plunge 555 ", 'en-us', 'ja-jp'), 
    ('Arlecchino doll\nI better not lose the 50/50 now... ', 'en-us', 'de-de'), 
    ('The only things keeping me sane\nwhat the title said xd\n\nThe keychain plush can be found on the Temu website/app. The pillow can be found on Amazon.', 'en-us', 'fr-fr'), 
    ("Just got Artem s bday card in six pulls...\nI was just doing it for fun to see what I'd get...I didn't think I actually would, I'm in utter shock and disbelief..So cute!!!", 'en-us', 'fr-fr'), 
    ("In search of new friends\nlooking for some new friends that are as interested, for Genshin and Star Rail, as me. Doesn’t have to be serious just chill vibesI'm on EU serversdiscord: dennis2300", 'en-us', 'th-th'), 
    ("I don t recommend my build\nI'm just trying this lineup thing, please ignore it. thank youThe content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~", 'en-us', 'id-id'), 
    ('Your worst nightmare\nYour worst nightmarePov: you need 1 more wish 😭 ', 'en-us', 'th-th'), 
    ('4.5 Abyss - Eula Hyperfridge / Lyney Mono Pyro\nSo, after playing physical Eula, I wanted to see, if my account would be ready for this. Since I am passively farming Flower of Paradise Lost for Thoma, I will shortly test how the artifacts I already have work on Shinobu.\n\nWhen Lyney came out, I thought about getting him to C2 but wanted to safe primos for more upcoming Fontaine characters. Since we still don t know when Clorinde will be presented and I have 170 wishes, maybe I roll to at least one 5-Star and keep safing on a 50/50 loss.\n\nPropably I will only do this, if Lynette on the new banner.\n\nI m not really interested in Arlecchino, to be perfectly honest. ', 'en-us', 'th-th'), 
    ('Another Hyperspecific Poll for Genshin Players!\nBringing this back because why not, this time featuring a proper cover photo (If you have alt accounts, please choose pertaining to your main account)', 'en-us', 'de-de'), 
    ('he looks so pretty in casual wear I cant-\nomagajd please your hand in marriage?!?!', 'en-us', 'th-th'), 
    ('Official 2024 Calendar ❤ Artem\nFinally got the time to unbox this! This arrived last month or February iirc and I m in love with this calendar design already compared to the 2023 version!\n\nThe cards / artprints can be swapped very easily and they re very good quality! The prints are so beautiful 🥺🤍', 'en-us', 'zh-cn'), 
    ('Thank you...\nThank you so much for 400 views!! ', 'en-us', 'en-us'), 
    ('WHAT.... silly wisher is insane\nHOYO PLEASE BE GENEROUS WITH US PLEASE HOYO😭', 'en-us', 'th-th'), 
    ("When in doubt, rainbow\nRainbow-coloured first aniversary cake#anniversary cake#Honkai Star Rail: First Anniversary CelebrationI have no idea what I'm doing", 'en-us', 'zh-cn'), 
    ('My boys with Eidolons :3\nI am warping for eidolons of favorite boys only XD', 'en-us', 'vi-vn'), 
    ('LYNEY MADE CHESTS APPEAR MAGICALLY\nLyney: Want to see a magic trick??\nMe: Sure, but DON T MAKE STUFF DISAPPEAR\nLyney: *Cutest smiles and makes all hillicurls disappear*\nMe: WELL WHAT IS THE TRICK?! \nLyney: This! *proceeds to show me the 3 chests*', 'en-us', 'ru-ru'), 
    ('Looks like it s time to level Barbara up.\nFinally I managed to get a healer to this stage. ', 'en-us', 'zh-tw'), 
    ('Recommend teams please!\nHi! what other characters would any of you recommend if I want to play aventurine and jingyuan in a team? I’m not really good at this game so any help is greatly appreciated :) ', 'en-us', 'de-de'), 
    ('Lucky E1 S1 in less than 200 pulls\nWon all the 50/50. Luck is on my side.', 'en-us', 'ja-jp'), 
    ('Genshin I order you to fix this!\nGenshin I order you to fix this!\nIn the 4.5 update I couldn’t log into my account no matter what I did! Please fix this bug.', 'en-us', 'id-id'), 
    ('Need Klee!💕\nIt has been forever and a day since I\'ve actually played, but Klee is my favorite "new" character (new for me, obviously lol).Hopefully, I\'ll get to enjoy her explosively cute personality and dynamite outfits~!😂💕', 'en-us', 'th-th'), 
    ('For Aventurine backgrounds ~\n1. What do you want to say to Aventurine after the Main Story in this patch?\n  → Please stay safe and share me your luck pleaseeee.\n2. Imagine what Aventurine would be like in his daily work!\n  → A full time gambler who always win!\n3. If you were to describe Aventurine using playing cards, which card you think he resembles?\n  → The ace of spades!', 'en-us', 'ru-ru'), 
    ("Almost 1 night just for find this chest\nCurrently trying to find all the chests in Penacony before there is an update for the new map I've gone around 3 times this map using Topaz and only 1 chest is left, it turns out it was the chest at the start when I arrived at the map, I thought I had taken it during the quest ", 'en-us', 'fr-fr'), 
    ('WAR IS OVER!\nfinally no more signora and that shi', 'en-us', 'ja-jp'), 
    ('Reminder about Penguin Boy🐧\nAs we get closer and closer to 4.6, please be reminded that Freminet, the sweet, shy, overlooked House of the Hearth orphan, BLOCKED a blow by The Knave (4th of the freaking Fatui Harbingers) They say you should be scared when the quiet kid snaps but personally, I can not wait to see how bad@ss Freminet is gonna be in the next patch ', 'en-us', 'th-th'), 
    ('This dude just give me what??\nI ve been strengthening my straightness by \\ ignoring\\  the mails i got from male characters and taking only gifts from waifus for half a year or so. And this dude just give me dream solvent like WHATTT?. Should I take this rare item or not?', 'en-us', 'ja-jp'), 
    ('Take that, Gorilla!\n1st half was easy, Acheron sweeps. 2nd half, used an almost mono-Imaginary team with Ruan Mei to quickly break the gorillas and Bronya. So this is the power of a limited sustainer.The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'zh-cn'), 
    ('🤔🤔🤔\nhow my star rail pulls went...', 'en-us', 'id-id'), 
    ('should I start a dtiys contest?\nI’ve been thinking abt starting one but idrk rn…the poll ends in a week. if there’a more yes’s than nos then there’ll be a dtiys. the character that I’ll use for this dtiys is Wynter (my hsr oc) since I’m still working on her bro and my first one', 'en-us', 'de-de'), 
    ("I have 50 pulls should I pull Aventurine OR Jingliu \nHELLO~~~Can anyone suggest me who should I pull Jingliu or Aventurine since I'M FP2 PLAYER AND I ONLY HAVE 50 PULLS", 'en-us', 'zh-tw'), 
    ('Full on auto!\nGot this team on auto and got full stars!The content is sourced from the Lineup Assistant tool. Click it to view the character and Relic stat details~', 'en-us', 'de-de'), 
    ('Perfect Coin Flip\nKaeya’s idle animations are my favorite!\n\n(I think I was trying to capture Chenyu Vale at a distance, but at least you can see Fontaine from here!', 'en-us', 'zh-tw'),
    ("""Dear Traveler,      
