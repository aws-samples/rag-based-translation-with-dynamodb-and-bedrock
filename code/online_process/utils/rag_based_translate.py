...
def translate_content(src_content, src_lang, dest_lang, model_id=model_id):
    retriever = TerminologyRetriever(REGION)
    prompt, multilingual_term_mapping = construct_translate_prompt(src_content, src_lang, dest_lang, retriever)
    print(f"prompt: {prompt}")
    print(f"multilingual_term_mapping: {multilingual_term_mapping}")
...
if __name__ == '__main__':
    translate_content('I am good at SageMaker', 'EN', 'CN')
